#!/usr/bin/env ruby
# Generate Xcode project for foo_jl_libvanced
...
BUNDLE_ID = "com.foobar2000.foo-jl-libvanced"
SDK_PATH = Fb2kSdk.path

COMPONENT_VERSION = Fb2kVersions.get("libvanced")
BUILD_NUMBER = Fb2kVersions.get_build_number("libvanced")
