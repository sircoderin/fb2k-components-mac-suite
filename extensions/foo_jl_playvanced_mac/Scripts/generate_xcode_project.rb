#!/usr/bin/env ruby
# Generate Xcode project for foo_jl_playvanced
...
BUNDLE_ID = "com.foobar2000.foo-jl-playvanced"
SDK_PATH = Fb2kSdk.path

COMPONENT_VERSION = Fb2kVersions.get("playvanced")
BUILD_NUMBER = Fb2kVersions.get_build_number("playvanced")
